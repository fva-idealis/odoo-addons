 ...
 */
odoo.define('website_google_address_form.address_form_autocomplete', function (require) {
    'use strict';
...
odoo.define('website_google_address_form.website_portal_form', function (require) {
    'use strict';

    require('web.dom_ready');
    var GooglePlacesAutocomplete = require('website_google_address_form.address_form_autocomplete');
...
odoo.define('website_google_address_form.website_sale_form', function (require) {
    'use strict';
